...
#pragma GCC diagnostic pop
            void *mkl_intel_lp64 = dlopen("libmkl_intel_lp64.so",
                                          RTLD_NOW | RTLD_GLOBAL);
